...
class WorkOutPlans extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className="layout-content d-none d-lg-flex col-md-12 align-items-center ui-bg-cover ui-bg-overlay-container p-5y" style={{backgroundImage: "url('assets/img/bg/Gym1.jpg')"}}>
